...
############################################################
#       File:       migrateB.sh
#       Purpose:    Pull App from QA to Dev
#
#       Version:
#       Parameters:
#       Created:
...
#
############################################################
# This program pulls the latest objects from the QA server
...
case $appid in
	...
	'rfin') xapp="RFIN"; db="Main"; valid=0;;
...
if [[ $valid -eq 1 ]]; then
	...
	# get version file
	echo "fetching version file from QA 146.."
	fetch ${appid}.ver
	...
	# get objects
	echo "fetching build ${x} object exports from QA 146.."
	fetch ${ofspec}.zip

	echo "fetching build ${x} data exports from QA 146.."
	fetch ${dfspec}.zip
